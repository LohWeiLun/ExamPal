...
import 'friends_individualpage.dart';

class FriendsHomepage extends StatefulWidget {
  @override
  _FriendsHomepageState createState() => _FriendsHomepageState();
}
...
class _FriendsHomepageState extends State<FriendsHomepage> {
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: ListView(
                ...
                children: [
                  // Wrap each buildConversationRow with GestureDetector
  ...
  Column buildConversationRow(
      String name, String message, String filename, int msgCount, BuildContext context) {
    return Column(
      children: [
        GestureDetector(
          onTap: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => IndividualPage(), // Replace with your individual page
              ),
            );
          },
          child: Row(
